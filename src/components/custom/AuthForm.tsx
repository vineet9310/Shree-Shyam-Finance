...
//           city: (values as RegisterFormValues).city,
//           state: (values as RegisterFormValues).state,
//           pincode: (values as RegisterFormValues).pincode,
//           role: 'user',
//         };
//         console.log("[AuthForm:Register] Attempting API registration with payload:", JSON.stringify(registerPayload, null, 2));
//         const response = await fetch('/api/users/register', {
...
//                         <FormControl>
//                           <Input placeholder="Your address" {...field} value={field.value || ''} disabled={isLoading} className="bg-input border-border focus:border-primary focus-visible:ring-primary rounded-md py-2.5 placeholder:text-muted-foreground/70 text-foreground" />
//                         </FormControl>
//                         <FormMessage />
//                       </FormItem>
//                     )}
...
//                           <FormControl>
//                             <Input placeholder="City" {...field} value={field.value || ''} disabled={isLoading} className="bg-input border-border focus:border-primary focus-visible:ring-primary rounded-md py-2.5 placeholder:text-muted-foreground/70 text-foreground" />
//                           </FormControl>
//                           <FormMessage />
//                         </FormItem>
//                       )}
...
//                           <FormControl>
//                             <Input placeholder="State" {...field} value={field.value || ''} disabled={isLoading} className="bg-input border-border focus:border-primary focus-visible:ring-primary rounded-md py-2.5 placeholder:text-muted-foreground/70 text-foreground" />
//                           </FormControl>
//                           <FormMessage />
//                         </FormItem>
//                       )}
...
//                         <FormControl>
//                           <Input placeholder="Pincode" {...field} value={field.value || ''} disabled={isLoading} className="bg-input border-border focus:border-primary focus-visible:ring-primary rounded-md py-2.5 placeholder:text-muted-foreground/70 text-foreground" />
//                         </FormControl>
//                         <FormMessage />
//                       </FormItem>
//                     )}
